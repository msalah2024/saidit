...
export default function Page() {
  ...
  useEffect(() => {
    if (comments.length === 0 && !hasFetched) {
      setHasFetched(true);
      return;
    }
  ...
  useEffect(() => {
    ...
    return () => {
      window.removeEventListener(
        "showTipTap",
        handleShowTipTap as EventListener
      );
    };
  }, []);
    ...
    <div className="overflow-hidden mb-10">
      <div className="mb-6 mt-1">
        {!showTipTap && !post.deleted && (
          <div
            ...
            className="p-3 rounded-3xl hover:cursor-text hover:bg-[#0e1216] border bg-saidit-black"
          >
        ...
        <div className="flex items-center flex-wrap gap-x-2 w-full">
          <SortComments
            sortBy={sortBy}
            setSortBy={setSortBy}
            disabled={normalizedComments.length === 0}
          />
          <SearchComments
        ...
        !hasSearched && (
          <div className="flex flex-col gap-1 p-2 w-full items-center text-center">
            ...
            <p className="text-muted-foreground select-none">
              Nobody&#39;s responded to this post yet. Add your thoughts and get
      ...
      {!isLoading && hasSearched && normalizedComments.length === 0 && (
        <div className="flex flex-col gap-1 p-2 w-full items-center text-center">
          ...
          <p className="text-muted-foreground select-none">
            Try a different keyword. Couldn’t find any comments matching your
            search.
          </p>
        </div>
      )}
