...
import { Archive, Rocket, Sparkles, Swords } from "lucide-react";

interface sortCommentsProps {
  setSortBy: React.Dispatch<
    React.SetStateAction<"best" | "new" | "old" | "controversial">
  >;
  sortBy: string;
  disabled: boolean;
}
  ...
  return (
    <div className="flex my-4 items-center mx-1 gap-2 w-full sm:w-fit">
      ...
      <Select value={sortBy} onValueChange={handleChange}>
        ...
        <SelectContent>
          <SelectItem className="hover:cursor-pointer" value="best">
            <Rocket className="text-primary-foreground" /> Best
          </SelectItem>
          <SelectItem className="hover:cursor-pointer" value="new">
            <Sparkles className="text-primary-foreground" />
            New
          </SelectItem>
          <SelectItem className="hover:cursor-pointer" value="old">
            <Archive className="text-primary-foreground" />
            Old
          </SelectItem>
          <SelectItem className="hover:cursor-pointer" value="controversial">
