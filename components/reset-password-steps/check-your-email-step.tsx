...
export default function CheckYourEmailStep() {
    return (
        <div className='flex flex-col items-center justify-center'>
            <Image src={resetPasswordImage} alt='reset-password-image' width={250} height={250} />
            <p className="leading-7 [&:not(:first-child)]:mt-6 text-sm text-muted-foreground">
                Didn&#39;t get an email? <Link href={"/home"} className='hover:underline text-foreground ml-1'>Resend</Link>
            </p>
        </div>
    )
}
