    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent className='mr-2 mt-2'>
                ...
                <DropdownMenuItem onClick={() => router.push('/protected/settings/account')} className='py-2 focus:bg-card mr-10'><Settings className='text-foreground' /> Settings</DropdownMenuItem>
                <DropdownMenuSeparator />
